          ...
          <Col>
            <Card className="text-center">
              <Card.Body>
                ...
                <Button className="corp-btn" size="sm" href="https://swe.berkeley.edu/img/corporate/UC-Berkeley-SWE-Corporate-Package-2022-23.pdf">
                  Review Package
                </Button>
              </Card.Body>
            </Card>
          ...
          <Col>
            <Card className="text-center">
              <Card.Body>
                ...
                <Button className="corp-btn" size="sm" href="https://www.linkedin.com/company/uc-berkeley-swe">
                  Follow SWE on LinkedIn
                </Button>
                <Button className="corp-btn" size="sm" href="https://www.linkedin.com/groups/12462059/">
